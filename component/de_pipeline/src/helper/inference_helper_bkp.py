...
def inference(location_groups, **context):
    ...
    def fd_inference(location_groups: list = [], config_data: dict = {}, run_date: str = None,
                     run_id: str = None) -> str:
        """
            ...
            worker_pool_specs = [{
                ...
                'container_spec': {
                    ...
                    "args": [
                        ...
                        '--output_path', config_data.get("output_path")+run_id+"/prediction",
    ...
    def pipeline(location_groups: list = [], config_data: dict = {}, run_date: str = None, run_id: str = None):
        ...
        """
        training_job_task = (
            fd_inference(location_groups=location_groups, config_data=config_data, run_date=run_date, run_id=run_id)
