...
class AuditDataHelper(Helper):
    ...
    def get_pyspark_audiit_args(self, location_groups) -> list:
        ...
        pyspark_args = ['--location_groups',
                        ...
                        '--mapping_path',
                        self.get_env_variable("dev-audit-apply", "mapping_path", "script_bucket", "script_folder"),
                        '--denorm_src_path',
                        self.get_env_variable("dev-audit-apply", "input_path", "base_bucket", "base_path"),
                        '--meta_src_path',
                        self.get_env_variable("dev-audit-apply", "meta_src_path", "base_bucket", 'base_path'),
                        '--dest_path',
                        self.get_env_variable("dev-audit-apply", "dest_path", "base_bucket", "base_path"),
                        '--historical_mode',
                        self.get_env_variable("dev-audit-apply", "historical_mode"),
                        '--current_date_str',
